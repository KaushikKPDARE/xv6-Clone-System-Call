...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 12 09 00 	movl   $0x912,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 421:	0f b6 80 38 0c 00 00 	movzbl 0xc38(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 57e:	75 09                	jne    589 <printf+0x101>
          s = "(null)";
 580:	c7 45 f4 2b 09 00 00 	movl   $0x92b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64b:	a1 54 0c 00 00       	mov    0xc54,%eax
...
free(void *ap)
{
 ...
 716:	a3 54 0c 00 00       	mov    %eax,0xc54
}
 71b:	c9                   	leave  
 71c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 769:	e8 ce fe ff ff       	call   63c <free>
  return freep;
 76e:	a1 54 0c 00 00       	mov    0xc54,%eax
}
 773:	c9                   	leave  
 774:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 787:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 78a:	a1 54 0c 00 00       	mov    0xc54,%eax
 78f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 792:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 796:	75 23                	jne    7bb <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 798:	c7 45 f0 4c 0c 00 00 	movl   $0xc4c,-0x10(%ebp)
 79f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a2:	a3 54 0c 00 00       	mov    %eax,0xc54
 7a7:	a1 54 0c 00 00       	mov    0xc54,%eax
 7ac:	a3 4c 0c 00 00       	mov    %eax,0xc4c
    base.s.size = 0;
 7b1:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 7b8:	00 00 00 
  }
 ...
 80e:	a3 54 0c 00 00       	mov    %eax,0xc54
      return (void*)(p + 1);
 ...
 819:	eb 38                	jmp    853 <malloc+0xde>
    ...
    if(p == freep)
 81b:	a1 54 0c 00 00       	mov    0xc54,%eax
