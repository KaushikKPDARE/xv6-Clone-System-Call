...
main(int argc, char *argv[])
{
 ...
 11e:	c7 44 24 04 d0 0b 00 	movl   $0xbd0,0x4(%esp)
 125:	00 
 ...
 1b0:	c7 44 24 04 f0 0b 00 	movl   $0xbf0,0x4(%esp)
 1b7:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6f1:	0f b6 80 94 0f 00 00 	movzbl 0xf94(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 84e:	75 09                	jne    859 <printf+0x101>
          s = "(null)";
 850:	c7 45 f4 06 0c 00 00 	movl   $0xc06,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 91b:	a1 c8 0f 00 00       	mov    0xfc8,%eax
...
free(void *ap)
{
 ...
 9e6:	a3 c8 0f 00 00       	mov    %eax,0xfc8
}
 9eb:	c9                   	leave  
 9ec:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a4e:	83 c0 07             	add    $0x7,%eax
 a51:	c1 e8 03             	shr    $0x3,%eax
 a54:	83 c0 01             	add    $0x1,%eax
 a57:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a5a:	a1 c8 0f 00 00       	mov    0xfc8,%eax
 a5f:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a62:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a66:	75 23                	jne    a8b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a68:	c7 45 f0 c0 0f 00 00 	movl   $0xfc0,-0x10(%ebp)
 a6f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a72:	a3 c8 0f 00 00       	mov    %eax,0xfc8
 a77:	a1 c8 0f 00 00       	mov    0xfc8,%eax
 a7c:	a3 c0 0f 00 00       	mov    %eax,0xfc0
    base.s.size = 0;
 a81:	c7 05 c4 0f 00 00 00 	movl   $0x0,0xfc4
 a88:	00 00 00 
  }
 ...
 ade:	a3 c8 0f 00 00       	mov    %eax,0xfc8
      return (void*)(p + 1);
 ae3:	8b 45 f4             	mov    -0xc(%ebp),%eax
 ae6:	83 c0 08             	add    $0x8,%eax
 ae9:	eb 38                	jmp    b23 <malloc+0xde>
    }
    if(p == freep)
 aeb:	a1 c8 0f 00 00       	mov    0xfc8,%eax
 af0:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 af3:	75 1b                	jne    b10 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
 af5:	8b 45 ec             	mov    -0x14(%ebp),%eax
 af8:	89 04 24             	mov    %eax,(%esp)
 afb:	e8 ed fe ff ff       	call   9ed <morecore>
 b00:	89 45 f4             	mov    %eax,-0xc(%ebp)
 b03:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
 b07:	75 07                	jne    b10 <malloc+0xcb>
        return 0;
 b09:	b8 00 00 00 00       	mov    $0x0,%eax
 b0e:	eb 13                	jmp    b23 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
 ...
 b1e:	e9 70 ff ff ff       	jmp    a93 <malloc+0x4e>
}
 b23:	c9                   	leave  
 b24:	c3                   	ret    
...
xchg(volatile uint *addr, uint newval)
{
 ...
 b34:	8b 4d 08             	mov    0x8(%ebp),%ecx
 b37:	f0 87 02             	lock xchg %eax,(%edx)
...
void mutex_init(mutex_t *m) {
 ...
 b48:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 b4e:	5d                   	pop    %ebp
 b4f:	c3                   	ret    
...
void mutex_lock(mutex_t *m)
{
 ...
 b5a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
 b61:	00 
 b62:	89 04 24             	mov    %eax,(%esp)
 b65:	e8 be ff ff ff       	call   b28 <xchg>
 b6a:	83 f8 01             	cmp    $0x1,%eax
 b6d:	74 e8                	je     b57 <mutex_lock+0x7>
}
 b6f:	c9                   	leave  
 b70:	c3                   	ret    

00000b71 <mutex_unlock>:
...
void mutex_unlock(mutex_t *m)
{
 ...
 b77:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
} 
 b7d:	5d                   	pop    %ebp
 b7e:	c3                   	ret    

00000b7f <thread_create>:
...
00000bb5 <thread_join>:

int thread_join(void)
{
 bb5:	55                   	push   %ebp
 bb6:	89 e5                	mov    %esp,%ebp
 bb8:	83 ec 28             	sub    $0x28,%esp
    void *join_s;
    int join_pid = join(&join_s);
 bbb:	8d 45 f0             	lea    -0x10(%ebp),%eax
 bbe:	89 04 24             	mov    %eax,(%esp)
 bc1:	e8 aa fa ff ff       	call   670 <join>
