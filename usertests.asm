...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      16:	e8 2d 40 00 00       	call   4048 <printf>
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      ...
      3b:	e8 08 40 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      65:	e8 de 3f 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      8f:	e8 b4 3f 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      ...
      b9:	e8 8a 3f 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "iput test ok\n");
      ...
      d3:	e8 70 3f 00 00       	call   4048 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      f0:	e8 53 3f 00 00       	call   4048 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     113:	e8 30 3f 00 00       	call   4048 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     147:	e8 fc 3e 00 00       	call   4048 <printf>
      exit();
    ...
    if(chdir("iputdir") < 0){
     ...
     171:	e8 d2 3e 00 00       	call   4048 <printf>
      exit();
    ...
    if(unlink("../iputdir") < 0){
     ...
     19b:	e8 a8 3e 00 00       	call   4048 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1bf:	e8 84 3e 00 00       	call   4048 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1dc:	e8 67 3e 00 00       	call   4048 <printf>
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     201:	e8 42 3e 00 00       	call   4048 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     229:	e8 1a 3e 00 00       	call   4048 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     266:	e8 dd 3d 00 00       	call   4048 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     ...
     2a1:	e8 a2 3d 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2c0:	e8 83 3d 00 00       	call   4048 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2dd:	e8 66 3d 00 00       	call   4048 <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     30f:	e8 34 3d 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     351:	e8 f2 3c 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "open test ok\n");
     ...
     36b:	e8 d8 3c 00 00       	call   4048 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     388:	e8 bb 3c 00 00       	call   4048 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3ba:	e8 89 3c 00 00       	call   4048 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3db:	e8 68 3c 00 00       	call   4048 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     41c:	e8 27 3c 00 00       	call   4048 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     45d:	e8 e6 3b 00 00       	call   4048 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     485:	e8 be 3b 00 00       	call   4048 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4c2:	e8 81 3b 00 00       	call   4048 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     500:	e8 43 3b 00 00       	call   4048 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     51a:	e8 29 3b 00 00       	call   4048 <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     54c:	e8 f7 3a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     566:	e8 dd 3a 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "small file test ok\n");
     ...
     580:	e8 c3 3a 00 00       	call   4048 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     59d:	e8 a6 3a 00 00       	call   4048 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     5cf:	e8 74 3a 00 00       	call   4048 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     625:	e8 1e 3a 00 00       	call   4048 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     675:	e8 ce 39 00 00       	call   4048 <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6ca:	e8 79 39 00 00       	call   4048 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     ...
     716:	e8 2d 39 00 00       	call   4048 <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     74e:	e8 f5 38 00 00       	call   4048 <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     771:	e8 d2 38 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "big files ok\n");
     ...
     78b:	e8 b8 38 00 00       	call   4048 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     7a8:	e8 9b 38 00 00       	call   4048 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     843:	e8 00 38 00 00       	call   4048 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     860:	e8 e3 37 00 00       	call   4048 <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     ...
     885:	e8 be 37 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8af:	e8 94 37 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     8d9:	e8 6a 37 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     903:	e8 40 37 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     91d:	e8 26 37 00 00       	call   4048 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     93a:	e8 09 37 00 00       	call   4048 <printf>
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     967:	e8 dc 36 00 00       	call   4048 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     997:	e8 ac 36 00 00       	call   4048 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a29:	e8 1a 36 00 00       	call   4048 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a9f:	e8 a4 35 00 00       	call   4048 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b15:	e8 2e 35 00 00       	call   4048 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     ...
     b3e:	e8 05 35 00 00       	call   4048 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     b54:	e8 ef 34 00 00       	call   4048 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     b75:	e8 ce 34 00 00       	call   4048 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bed:	e8 56 34 00 00       	call   4048 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     c39:	e8 0a 34 00 00       	call   4048 <printf>
  ...
  printf(1, "kill... ");
     ...
     c5a:	e8 e9 33 00 00       	call   4048 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     c8f:	e8 b4 33 00 00       	call   4048 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     cb2:	e8 91 33 00 00       	call   4048 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     ce5:	e8 5e 33 00 00       	call   4048 <printf>
      return;
    ...
    if(pid){
     ...
     d0b:	e8 38 33 00 00       	call   4048 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     d30:	e8 13 33 00 00       	call   4048 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     d4c:	e8 f7 32 00 00       	call   4048 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     ddc:	e8 67 32 00 00       	call   4048 <printf>
      kill(ppid);
    ...
    printf(1, "mem ok\n");
     ...
     e0b:	e8 38 32 00 00       	call   4048 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     e31:	e8 12 32 00 00       	call   4048 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     e6e:	e8 d5 31 00 00       	call   4048 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ee0:	e8 63 31 00 00       	call   4048 <printf>
      break;
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     f3b:	e8 08 31 00 00       	call   4048 <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fea:	e8 59 30 00 00       	call   4048 <printf>
    ...
    100e:	e8 35 30 00 00       	call   4048 <printf>
    exit();
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    ...
    104b:	e8 f8 2f 00 00       	call   4048 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    108e:	e8 b5 2f 00 00       	call   4048 <printf>
      exit();
    ...
    10cd:	e8 76 2f 00 00       	call   4048 <printf>
        exit();
    ...
    113b:	e8 08 2f 00 00       	call   4048 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11df:	e8 64 2e 00 00       	call   4048 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1249:	e8 fa 2d 00 00       	call   4048 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    ...
    127b:	e8 c8 2d 00 00       	call   4048 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    1297:	e8 ac 2d 00 00       	call   4048 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12c5:	e8 7e 2d 00 00       	call   4048 <printf>
      exit();
    ...
    1326:	e8 1d 2d 00 00       	call   4048 <printf>
          exit();
    ...
    137b:	e8 c8 2c 00 00       	call   4048 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1438:	e8 0b 2c 00 00       	call   4048 <printf>
        exit();
    ...
    146a:	e8 d9 2b 00 00       	call   4048 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    14f3:	e8 50 2b 00 00       	call   4048 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    150f:	e8 34 2b 00 00       	call   4048 <printf>
  ...
  if(fd < 0){
    ...
    1540:	e8 03 2b 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    159c:	e8 a7 2a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c5:	e8 7e 2a 00 00       	call   4048 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    163b:	e8 08 2a 00 00       	call   4048 <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    165f:	e8 e4 29 00 00       	call   4048 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1698:	e8 ab 29 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "unlinkread ok\n");
    ...
    16c8:	e8 7b 29 00 00       	call   4048 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    16e4:	e8 5f 29 00 00       	call   4048 <printf>
  ...
  if(fd < 0){
    ...
    172d:	e8 16 29 00 00       	call   4048 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1766:	e8 dd 28 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    ...
    17a2:	e8 a1 28 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    ...
    17df:	e8 64 28 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1815:	e8 2e 28 00 00       	call   4048 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    184e:	e8 f5 27 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    188a:	e8 b9 27 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    18c7:	e8 7c 27 00 00       	call   4048 <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    ...
    18f8:	e8 4b 27 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "linktest ok\n");
    ...
    1911:	e8 32 27 00 00       	call   4048 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    192d:	e8 16 27 00 00       	call   4048 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1a14:	e8 2f 26 00 00       	call   4048 <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1adb:	e8 68 25 00 00       	call   4048 <printf>
        exit();
    ...
    1b0d:	e8 36 25 00 00       	call   4048 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b68:	e8 db 24 00 00       	call   4048 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1ba4:	e8 9f 24 00 00       	call   4048 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    1cc4:	e8 7f 23 00 00       	call   4048 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ce0:	e8 63 23 00 00       	call   4048 <printf>
  ...
  if(pid < 0){
    ...
    1d0e:	e8 35 23 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1df2:	e8 51 22 00 00       	call   4048 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1e0e:	e8 35 22 00 00       	call   4048 <printf>
  unlink("bd");
  ...
  if(fd < 0){
    ...
    1e4b:	e8 f8 21 00 00       	call   4048 <printf>
    exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1ebf:	e8 84 21 00 00       	call   4048 <printf>
      exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    1f39:	e8 0a 21 00 00       	call   4048 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1f5f:	e8 e4 20 00 00       	call   4048 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1f7b:	e8 c8 20 00 00       	call   4048 <printf>
  ...
  if(mkdir("dd") != 0){
    ...
    1fab:	e8 98 20 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1fe1:	e8 62 20 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    ...
    2030:	e8 13 20 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2059:	e8 ea 1f 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    208f:	e8 b4 1f 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    20eb:	e8 58 1f 00 00       	call   4048 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20fc:	00 
    20fd:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    2104:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2119:	0f b6 05 20 8c 00 00 	movzbl 0x8c20,%eax
    ...
    2133:	e8 10 1f 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    216f:	e8 d4 1e 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2198:	e8 ab 1e 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21c9:	e8 7a 1e 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    ...
    21f2:	e8 51 1e 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    221b:	e8 28 1e 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2244:	e8 ff 1d 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    ...
    226d:	e8 d6 1d 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    22a3:	e8 a0 1d 00 00       	call   4048 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22b4:	00 
    22b5:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    22bc:	00 
    ...
    22dc:	e8 67 1d 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2318:	e8 2b 1d 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2349:	e8 fa 1c 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    237a:	e8 c9 1c 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    23ab:	e8 98 1c 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23dc:	e8 67 1c 00 00       	call   4048 <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    240d:	e8 36 1c 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    243e:	e8 05 1c 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    246f:	e8 d4 1b 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    24a0:	e8 a3 1b 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24c9:	e8 7a 1b 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24f2:	e8 51 1b 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    251b:	e8 28 1b 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2544:	e8 ff 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    256d:	e8 d6 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    ...
    2596:	e8 ad 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    ...
    25bf:	e8 84 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25e8:	e8 5b 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    ...
    2611:	e8 32 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    ...
    263a:	e8 09 1a 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    ...
    2663:	e8 e0 19 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    ...
    268c:	e8 b7 19 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "subdir ok\n");
    ...
    26a5:	e8 9e 19 00 00       	call   4048 <printf>
}
    26aa:	c9                   	leave  
    26ab:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26c1:	e8 82 19 00 00       	call   4048 <printf>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    270a:	e8 39 19 00 00       	call   4048 <printf>
      exit();
    ...
    2724:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    272b:	00 
    ...
    275f:	e8 e4 18 00 00       	call   4048 <printf>
        exit();
  ...
  printf(1, "bigwrite ok\n");
    ...
    27ad:	e8 96 18 00 00       	call   4048 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27c9:	e8 7a 18 00 00       	call   4048 <printf>
  ...
  if(fd < 0){
    ...
    2806:	e8 3d 18 00 00       	call   4048 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2828:	c7 04 24 20 8c 00 00 	movl   $0x8c20,(%esp)
    282f:	e8 d7 14 00 00       	call   3d0b <memset>
    if(write(fd, buf, 600) != 600){
    2834:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    283b:	00 
    283c:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    2843:	00 
    ...
    2865:	e8 de 17 00 00       	call   4048 <printf>
      exit();
  ...
  if(fd < 0){
    ...
    28b0:	e8 93 17 00 00       	call   4048 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28cf:	00 
    28d0:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    28d7:	00 
    ...
    28fb:	e8 48 17 00 00       	call   4048 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    293e:	e8 05 17 00 00       	call   4048 <printf>
      exit();
    2943:	e8 70 15 00 00       	call   3eb8 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    2948:	0f b6 05 20 8c 00 00 	movzbl 0x8c20,%eax
    ...
    2962:	0f b6 05 4b 8d 00 00 	movzbl 0x8d4b,%eax
    ...
    298b:	e8 b8 16 00 00       	call   4048 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29b3:	e8 90 16 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "bigfile test ok\n");
    ...
    29d8:	e8 6b 16 00 00       	call   4048 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29f4:	e8 4f 16 00 00       	call   4048 <printf>
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2a18:	e8 2b 16 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a41:	e8 02 16 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2a77:	e8 cc 15 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2ab8:	e8 8b 15 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2aec:	e8 57 15 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2b15:	e8 2e 15 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "fourteen ok\n");
    ...
    2b2e:	e8 15 15 00 00       	call   4048 <printf>
}
    2b33:	c9                   	leave  
    2b34:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b4a:	e8 f9 14 00 00       	call   4048 <printf>
  if(mkdir("dots") != 0){
    ...
    2b6e:	e8 d5 14 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dots") != 0){
    ...
    2b97:	e8 ac 14 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink(".") == 0){
    ...
    2bc0:	e8 83 14 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("..") == 0){
    ...
    2be9:	e8 5a 14 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("/") != 0){
    ...
    2c12:	e8 31 14 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dots/.") == 0){
    ...
    2c3b:	e8 08 14 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dots/..") == 0){
    ...
    2c64:	e8 df 13 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dots") != 0){
    ...
    2c8d:	e8 b6 13 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "rmdot ok\n");
    ...
    2ca6:	e8 9d 13 00 00       	call   4048 <printf>
}
    2cab:	c9                   	leave  
    2cac:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2cc2:	e8 81 13 00 00       	call   4048 <printf>
  ...
  if(fd < 0){
    ...
    2cf3:	e8 50 13 00 00       	call   4048 <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    2d27:	e8 1c 13 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2d5d:	e8 e6 12 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2d93:	e8 b0 12 00 00       	call   4048 <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2dbc:	e8 87 12 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2de5:	e8 5e 12 00 00       	call   4048 <printf>
    exit();
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e16:	e8 2d 12 00 00       	call   4048 <printf>
    exit();
  ...
  if(unlink("dirfile") != 0){
    ...
    2e3f:	e8 04 12 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    2e75:	e8 ce 11 00 00       	call   4048 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ec4:	e8 7f 11 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    ...
    2ee8:	e8 5b 11 00 00       	call   4048 <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2f04:	e8 3f 11 00 00       	call   4048 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f34:	e8 0f 11 00 00       	call   4048 <printf>
      exit();
    ...
    2f5d:	e8 e6 10 00 00       	call   4048 <printf>
      exit();
  ...
  printf(1, "empty file name OK\n");
    ...
    300c:	e8 37 10 00 00       	call   4048 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3028:	e8 1b 10 00 00       	call   4048 <printf>
    ...
    304c:	e8 67 0e 00 00       	call   3eb8 <exit>
{
  ...
  if(n == 1000){
    ...
    3076:	e8 cd 0f 00 00       	call   4048 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    309a:	e8 a9 0f 00 00       	call   4048 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30c7:	e8 7c 0f 00 00       	call   4048 <printf>
    exit();
  ...
  printf(1, "fork test OK\n");
    ...
    30e0:	e8 63 0f 00 00       	call   4048 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 40 64 00 00       	mov    0x6440,%eax
    30f6:	c7 44 24 04 a7 58 00 	movl   $0x58a7,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 42 0f 00 00       	call   4048 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3144:	a1 40 64 00 00       	mov    0x6440,%eax
    ...
    3169:	e8 da 0e 00 00       	call   4048 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 40 64 00 00       	mov    0x6440,%eax
    31a2:	c7 44 24 04 cd 58 00 	movl   $0x58cd,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 96 0e 00 00       	call   4048 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 40 64 00 00       	mov    0x6440,%eax
    31e5:	c7 44 24 04 e4 58 00 	movl   $0x58e4,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 53 0e 00 00       	call   4048 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    323e:	a1 40 64 00 00       	mov    0x6440,%eax
    3243:	c7 44 24 04 00 59 00 	movl   $0x5900,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 f5 0d 00 00       	call   4048 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 40 64 00 00       	mov    0x6440,%eax
    328e:	c7 44 24 04 3e 59 00 	movl   $0x593e,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 aa 0d 00 00       	call   4048 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 40 64 00 00       	mov    0x6440,%eax
    ...
    32dd:	e8 66 0d 00 00       	call   4048 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 40 64 00 00       	mov    0x6440,%eax
    ...
    3344:	e8 ff 0c 00 00       	call   4048 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 40 64 00 00       	mov    0x6440,%eax
    335d:	c7 44 24 04 bc 59 00 	movl   $0x59bc,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 db 0c 00 00       	call   4048 <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 40 64 00 00       	mov    0x6440,%eax
    ...
    33c5:	e8 7e 0c 00 00       	call   4048 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 40 64 00 00       	mov    0x6440,%eax
    33f3:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 45 0c 00 00       	call   4048 <printf>
      exit();
    ...
    3417:	a1 40 64 00 00       	mov    0x6440,%eax
    ...
    3432:	e8 11 0c 00 00       	call   4048 <printf>
      kill(ppid);
  ...
  if(pipe(fds) != 0){
    ...
    347e:	e8 c5 0b 00 00       	call   4048 <printf>
    exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 40 64 00 00       	mov    0x6440,%eax
    3578:	c7 44 24 04 26 5a 00 	movl   $0x5a26,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 c0 0a 00 00       	call   4048 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 40 64 00 00       	mov    0x6440,%eax
    35be:	c7 44 24 04 41 5a 00 	movl   $0x5a41,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 7a 0a 00 00       	call   4048 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 40 64 00 00       	mov    0x6440,%eax
    3604:	c7 44 24 04 4f 5a 00 	movl   $0x5a4f,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 34 0a 00 00       	call   4048 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3682:	a1 40 64 00 00       	mov    0x6440,%eax
    3687:	c7 44 24 04 69 5a 00 	movl   $0x5a69,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 b1 09 00 00       	call   4048 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 40 64 00 00       	mov    0x6440,%eax
    36b4:	c7 44 24 04 82 5a 00 	movl   $0x5a82,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 84 09 00 00       	call   4048 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 40 64 00 00       	mov    0x6440,%eax
    3726:	c7 44 24 04 aa 5a 00 	movl   $0x5aaa,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 12 09 00 00       	call   4048 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 60 64 00 00 	movl   $0x5ac4,0x6460(,%eax,4)
    376f:	c4 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    377b:	7e e8                	jle    3765 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    377d:	c7 05 dc 64 00 00 00 	movl   $0x0,0x64dc
    3784:	00 00 00 
    printf(stdout, "bigarg test\n");
    3787:	a1 40 64 00 00       	mov    0x6440,%eax
    378c:	c7 44 24 04 a1 5b 00 	movl   $0x5ba1,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 ac 08 00 00       	call   4048 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 60 64 00 	movl   $0x6460,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
    37ab:	e8 40 07 00 00       	call   3ef0 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 40 64 00 00       	mov    0x6440,%eax
    37b5:	c7 44 24 04 ae 5b 00 	movl   $0x5bae,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 83 08 00 00       	call   4048 <printf>
    ...
    37f2:	a1 40 64 00 00       	mov    0x6440,%eax
    37f7:	c7 44 24 04 be 5b 00 	movl   $0x5bbe,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 41 08 00 00       	call   4048 <printf>
    exit();
  ...
  if(fd < 0){
    ...
    382e:	a1 40 64 00 00       	mov    0x6440,%eax
    3833:	c7 44 24 04 d7 5b 00 	movl   $0x5bd7,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 05 08 00 00       	call   4048 <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    387e:	e8 c5 07 00 00       	call   4048 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3968:	e8 db 06 00 00       	call   4048 <printf>
    ...
    399f:	e8 a4 06 00 00       	call   4048 <printf>
      break;
    ...
    39b4:	00 
    39b5:	c7 44 24 04 20 8c 00 	movl   $0x8c20,0x4(%esp)
    39bc:	00 
    ...
    39eb:	e8 58 06 00 00       	call   4048 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3b0f:	e8 34 05 00 00       	call   4048 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b1d:	a1 44 64 00 00       	mov    0x6444,%eax
    3b22:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b28:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b2d:	a3 44 64 00 00       	mov    %eax,0x6444
  return randstate;
    3b32:	a1 44 64 00 00       	mov    0x6444,%eax
}
    3b37:	5d                   	pop    %ebp
    3b38:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3b51:	e8 f2 04 00 00       	call   4048 <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    3b7d:	e8 c6 04 00 00       	call   4048 <printf>
    exit();
...
00003f58 <clone>:
SYSCALL(clone)
    3f58:	b8 16 00 00 00       	mov    $0x16,%eax
    3f5d:	cd 40                	int    $0x40
    3f5f:	c3                   	ret    

00003f60 <join>:
    3f60:	b8 17 00 00 00       	mov    $0x17,%eax
    3f65:	cd 40                	int    $0x40
    3f67:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3f6b:	83 ec 18             	sub    $0x18,%esp
    3f6e:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f71:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f74:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3f7b:	00 
    3f7c:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3f7f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f83:	8b 45 08             	mov    0x8(%ebp),%eax
    3f86:	89 04 24             	mov    %eax,(%esp)
    3f89:	e8 4a ff ff ff       	call   3ed8 <write>
}
    3f8e:	c9                   	leave  
    3f8f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3f98:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3f9f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fa3:	74 17                	je     3fbc <printint+0x2c>
    3fa5:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fa9:	79 11                	jns    3fbc <printint+0x2c>
    neg = 1;
    3fab:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fb2:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fb5:	f7 d8                	neg    %eax
    3fb7:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fba:	eb 06                	jmp    3fc2 <printint+0x32>
  } else {
    x = xx;
    3fbc:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fbf:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3fc2:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fc9:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3fcc:	8d 41 01             	lea    0x1(%ecx),%eax
    3fcf:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3fd2:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3fd5:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3fd8:	ba 00 00 00 00       	mov    $0x0,%edx
    3fdd:	f7 f3                	div    %ebx
    3fdf:	89 d0                	mov    %edx,%eax
    3fe1:	0f b6 80 48 64 00 00 	movzbl 0x6448(%eax),%eax
    3fe8:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    3fec:	8b 75 10             	mov    0x10(%ebp),%esi
    3fef:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ff2:	ba 00 00 00 00       	mov    $0x0,%edx
    3ff7:	f7 f6                	div    %esi
    3ff9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3ffc:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4000:	75 c7                	jne    3fc9 <printint+0x39>
  if(neg)
    4002:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4006:	74 10                	je     4018 <printint+0x88>
    buf[i++] = '-';
    4008:	8b 45 f4             	mov    -0xc(%ebp),%eax
    400b:	8d 50 01             	lea    0x1(%eax),%edx
    400e:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4011:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4016:	eb 1f                	jmp    4037 <printint+0xa7>
    4018:	eb 1d                	jmp    4037 <printint+0xa7>
    putc(fd, buf[i]);
    401a:	8d 55 dc             	lea    -0x24(%ebp),%edx
    401d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4020:	01 d0                	add    %edx,%eax
    4022:	0f b6 00             	movzbl (%eax),%eax
    4025:	0f be c0             	movsbl %al,%eax
    4028:	89 44 24 04          	mov    %eax,0x4(%esp)
    402c:	8b 45 08             	mov    0x8(%ebp),%eax
    402f:	89 04 24             	mov    %eax,(%esp)
    4032:	e8 31 ff ff ff       	call   3f68 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4037:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    403b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    403f:	79 d9                	jns    401a <printint+0x8a>
    putc(fd, buf[i]);
}
    4041:	83 c4 30             	add    $0x30,%esp
    4044:	5b                   	pop    %ebx
    4045:	5e                   	pop    %esi
    4046:	5d                   	pop    %ebp
    4047:	c3                   	ret    
...
{
    4048:	55                   	push   %ebp
    4049:	89 e5                	mov    %esp,%ebp
    404b:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
    4055:	8d 45 0c             	lea    0xc(%ebp),%eax
    4058:	83 c0 04             	add    $0x4,%eax
    405b:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    405e:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4065:	e9 7c 01 00 00       	jmp    41e6 <printf+0x19e>
    c = fmt[i] & 0xff;
    406a:	8b 55 0c             	mov    0xc(%ebp),%edx
    406d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4070:	01 d0                	add    %edx,%eax
    4072:	0f b6 00             	movzbl (%eax),%eax
    4075:	0f be c0             	movsbl %al,%eax
    4078:	25 ff 00 00 00       	and    $0xff,%eax
    407d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    4080:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4084:	75 2c                	jne    40b2 <printf+0x6a>
      if(c == '%'){
    4086:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    408a:	75 0c                	jne    4098 <printf+0x50>
        state = '%';
    408c:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    4093:	e9 4a 01 00 00       	jmp    41e2 <printf+0x19a>
      } else {
        putc(fd, c);
    4098:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    409b:	0f be c0             	movsbl %al,%eax
    409e:	89 44 24 04          	mov    %eax,0x4(%esp)
    40a2:	8b 45 08             	mov    0x8(%ebp),%eax
    40a5:	89 04 24             	mov    %eax,(%esp)
    40a8:	e8 bb fe ff ff       	call   3f68 <putc>
    40ad:	e9 30 01 00 00       	jmp    41e2 <printf+0x19a>
      }
    } else if(state == '%'){
    40b2:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40b6:	0f 85 26 01 00 00    	jne    41e2 <printf+0x19a>
      if(c == 'd'){
    40bc:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40c0:	75 2d                	jne    40ef <printf+0xa7>
        printint(fd, *ap, 10, 1);
    40c2:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40c5:	8b 00                	mov    (%eax),%eax
    40c7:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    40ce:	00 
    40cf:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    40d6:	00 
    40d7:	89 44 24 04          	mov    %eax,0x4(%esp)
    40db:	8b 45 08             	mov    0x8(%ebp),%eax
    40de:	89 04 24             	mov    %eax,(%esp)
    40e1:	e8 aa fe ff ff       	call   3f90 <printint>
        ap++;
    40e6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    40ea:	e9 ec 00 00 00       	jmp    41db <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    40ef:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    40f3:	74 06                	je     40fb <printf+0xb3>
    40f5:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    40f9:	75 2d                	jne    4128 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    40fb:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40fe:	8b 00                	mov    (%eax),%eax
    4100:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4107:	00 
    4108:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    410f:	00 
    4110:	89 44 24 04          	mov    %eax,0x4(%esp)
    4114:	8b 45 08             	mov    0x8(%ebp),%eax
    4117:	89 04 24             	mov    %eax,(%esp)
    411a:	e8 71 fe ff ff       	call   3f90 <printint>
        ap++;
    411f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4123:	e9 b3 00 00 00       	jmp    41db <printf+0x193>
      } else if(c == 's'){
    4128:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    412c:	75 45                	jne    4173 <printf+0x12b>
        s = (char*)*ap;
    412e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4131:	8b 00                	mov    (%eax),%eax
    4133:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4136:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    413a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    413e:	75 09                	jne    4149 <printf+0x101>
          s = "(null)";
    4140:	c7 45 f4 8a 5c 00 00 	movl   $0x5c8a,-0xc(%ebp)
        while(*s != 0){
    4147:	eb 1e                	jmp    4167 <printf+0x11f>
    4149:	eb 1c                	jmp    4167 <printf+0x11f>
          putc(fd, *s);
    414b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    414e:	0f b6 00             	movzbl (%eax),%eax
    4151:	0f be c0             	movsbl %al,%eax
    4154:	89 44 24 04          	mov    %eax,0x4(%esp)
    4158:	8b 45 08             	mov    0x8(%ebp),%eax
    415b:	89 04 24             	mov    %eax,(%esp)
    415e:	e8 05 fe ff ff       	call   3f68 <putc>
          s++;
    4163:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    4167:	8b 45 f4             	mov    -0xc(%ebp),%eax
    416a:	0f b6 00             	movzbl (%eax),%eax
    416d:	84 c0                	test   %al,%al
    416f:	75 da                	jne    414b <printf+0x103>
    4171:	eb 68                	jmp    41db <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4173:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4177:	75 1d                	jne    4196 <printf+0x14e>
        putc(fd, *ap);
    ...
    418b:	e8 d8 fd ff ff       	call   3f68 <putc>
        ap++;
    4190:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4194:	eb 45                	jmp    41db <printf+0x193>
      } else if(c == '%'){
    4196:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    419a:	75 17                	jne    41b3 <printf+0x16b>
        putc(fd, c);
    419c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    419f:	0f be c0             	movsbl %al,%eax
    41a2:	89 44 24 04          	mov    %eax,0x4(%esp)
    41a6:	8b 45 08             	mov    0x8(%ebp),%eax
    41a9:	89 04 24             	mov    %eax,(%esp)
    41ac:	e8 b7 fd ff ff       	call   3f68 <putc>
    41b1:	eb 28                	jmp    41db <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41b3:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    41ba:	00 
    41bb:	8b 45 08             	mov    0x8(%ebp),%eax
    41be:	89 04 24             	mov    %eax,(%esp)
    41c1:	e8 a2 fd ff ff       	call   3f68 <putc>
        putc(fd, c);
    41c6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41c9:	0f be c0             	movsbl %al,%eax
    41cc:	89 44 24 04          	mov    %eax,0x4(%esp)
    41d0:	8b 45 08             	mov    0x8(%ebp),%eax
    41d3:	89 04 24             	mov    %eax,(%esp)
    41d6:	e8 8d fd ff ff       	call   3f68 <putc>
      }
      state = 0;
    41db:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    41e2:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    41e6:	8b 55 0c             	mov    0xc(%ebp),%edx
    41e9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41ec:	01 d0                	add    %edx,%eax
    41ee:	0f b6 00             	movzbl (%eax),%eax
    41f1:	84 c0                	test   %al,%al
    41f3:	0f 85 71 fe ff ff    	jne    406a <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    420b:	a1 e8 64 00 00       	mov    0x64e8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    42d6:	a3 e8 64 00 00       	mov    %eax,0x64e8
}
    42db:	c9                   	leave  
    42dc:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    42fc:	e8 3f fc ff ff       	call   3f40 <sbrk>
  ...
  return freep;
    432e:	a1 e8 64 00 00       	mov    0x64e8,%eax
}
    4333:	c9                   	leave  
    4334:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    434a:	a1 e8 64 00 00       	mov    0x64e8,%eax
    434f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4352:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4356:	75 23                	jne    437b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4358:	c7 45 f0 e0 64 00 00 	movl   $0x64e0,-0x10(%ebp)
    435f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4362:	a3 e8 64 00 00       	mov    %eax,0x64e8
    4367:	a1 e8 64 00 00       	mov    0x64e8,%eax
    436c:	a3 e0 64 00 00       	mov    %eax,0x64e0
    base.s.size = 0;
    4371:	c7 05 e4 64 00 00 00 	movl   $0x0,0x64e4
    4378:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43ce:	a3 e8 64 00 00       	mov    %eax,0x64e8
      return (void*)(p + 1);
    ...
    if(p == freep)
    43db:	a1 e8 64 00 00       	mov    0x64e8,%eax
...
xchg(volatile uint *addr, uint newval)
{
    ...
    441b:	83 ec 10             	sub    $0x10,%esp
  uint result;
  
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
    441e:	8b 55 08             	mov    0x8(%ebp),%edx
    4421:	8b 45 0c             	mov    0xc(%ebp),%eax
    4424:	8b 4d 08             	mov    0x8(%ebp),%ecx
    4427:	f0 87 02             	lock xchg %eax,(%edx)
    442a:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
    442d:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
    4430:	c9                   	leave  
    4431:	c3                   	ret    
...
void mutex_lock(mutex_t *m)
{
    ...
    4443:	83 ec 08             	sub    $0x8,%esp
  while (xchg(&m->flag, 1) == 1); // spin-wait (do nothing)
    4446:	90                   	nop
    4447:	8b 45 08             	mov    0x8(%ebp),%eax
    444a:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    4451:	00 
    4452:	89 04 24             	mov    %eax,(%esp)
    4455:	e8 be ff ff ff       	call   4418 <xchg>
    445a:	83 f8 01             	cmp    $0x1,%eax
    445d:	74 e8                	je     4447 <mutex_lock+0x7>
}
    445f:	c9                   	leave  
    4460:	c3                   	ret    

00004461 <mutex_unlock>:

void mutex_unlock(mutex_t *m)
{
    4461:	55                   	push   %ebp
    4462:	89 e5                	mov    %esp,%ebp
  m->flag = 0;
    4464:	8b 45 08             	mov    0x8(%ebp),%eax
    4467:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
} 
    446d:	5d                   	pop    %ebp
    446e:	c3                   	ret    

0000446f <thread_create>:
...
{
    446f:	55                   	push   %ebp
    4470:	89 e5                	mov    %esp,%ebp
    4472:	83 ec 28             	sub    $0x28,%esp
	void *stack = malloc(4096);
    4475:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    447c:	e8 b4 fe ff ff       	call   4335 <malloc>
    4481:	89 45 f4             	mov    %eax,-0xc(%ebp)
	int clone_pid = clone(child, arg_ptr, stack);
    4484:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4487:	89 44 24 08          	mov    %eax,0x8(%esp)
    448b:	8b 45 0c             	mov    0xc(%ebp),%eax
    448e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4492:	8b 45 08             	mov    0x8(%ebp),%eax
    4495:	89 04 24             	mov    %eax,(%esp)
    4498:	e8 bb fa ff ff       	call   3f58 <clone>
...
000044a5 <thread_join>:

int thread_join(void)
{
    44a5:	55                   	push   %ebp
    44a6:	89 e5                	mov    %esp,%ebp
    44a8:	83 ec 28             	sub    $0x28,%esp
    void *join_s;
    int join_pid = join(&join_s);
    44ab:	8d 45 f0             	lea    -0x10(%ebp),%eax
    44ae:	89 04 24             	mov    %eax,(%esp)
    44b1:	e8 aa fa ff ff       	call   3f60 <join>
