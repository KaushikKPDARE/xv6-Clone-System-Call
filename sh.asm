...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     220:	e8 cf 0e 00 00       	call   10f4 <printf>
  memset(buf, 0, nbuf);
     ...
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     30b:	e8 e4 0d 00 00       	call   10f4 <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     373:	e8 7c 0d 00 00       	call   10f4 <printf>
  exit();
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3af:	e8 2d 10 00 00       	call   13e1 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ed:	e8 ef 0f 00 00       	call   13e1 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     458:	e8 84 0f 00 00       	call   13e1 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4a8:	e8 34 0f 00 00       	call   13e1 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4f8:	e8 e4 0e 00 00       	call   13e1 <malloc>
...
parsecmd(char *s)
{
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     759:	e8 96 09 00 00       	call   10f4 <printf>
    panic("syntax");
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    1035:	e8 4a ff ff ff       	call   f84 <write>
}
    103a:	c9                   	leave  
    103b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    1044:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    104b:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    104f:	74 17                	je     1068 <printint+0x2c>
    1051:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    1055:	79 11                	jns    1068 <printint+0x2c>
    neg = 1;
    1057:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    105e:	8b 45 0c             	mov    0xc(%ebp),%eax
    1061:	f7 d8                	neg    %eax
    1063:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1066:	eb 06                	jmp    106e <printint+0x32>
  } else {
    x = xx;
    1068:	8b 45 0c             	mov    0xc(%ebp),%eax
    106b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    106e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    1075:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    1078:	8d 41 01             	lea    0x1(%ecx),%eax
    107b:	89 45 f4             	mov    %eax,-0xc(%ebp)
    107e:	8b 5d 10             	mov    0x10(%ebp),%ebx
    1081:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1084:	ba 00 00 00 00       	mov    $0x0,%edx
    1089:	f7 f3                	div    %ebx
    108b:	89 d0                	mov    %edx,%eax
    108d:	0f b6 80 b4 1b 00 00 	movzbl 0x1bb4(%eax),%eax
    1094:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    1098:	8b 75 10             	mov    0x10(%ebp),%esi
    ...
    10ac:	75 c7                	jne    1075 <printint+0x39>
  if(neg)
    10ae:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10b2:	74 10                	je     10c4 <printint+0x88>
    buf[i++] = '-';
    10b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10b7:	8d 50 01             	lea    0x1(%eax),%edx
    10ba:	89 55 f4             	mov    %edx,-0xc(%ebp)
    10bd:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    10c2:	eb 1f                	jmp    10e3 <printint+0xa7>
    10c4:	eb 1d                	jmp    10e3 <printint+0xa7>
    putc(fd, buf[i]);
    10c6:	8d 55 dc             	lea    -0x24(%ebp),%edx
    ...
    10de:	e8 31 ff ff ff       	call   1014 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    10eb:	79 d9                	jns    10c6 <printint+0x8a>
    putc(fd, buf[i]);
}
    10ed:	83 c4 30             	add    $0x30,%esp
    10f0:	5b                   	pop    %ebx
    10f1:	5e                   	pop    %esi
    10f2:	5d                   	pop    %ebp
    10f3:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1111:	e9 7c 01 00 00       	jmp    1292 <printf+0x19e>
    c = fmt[i] & 0xff;
    ...
    1124:	25 ff 00 00 00       	and    $0xff,%eax
    1129:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    112c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1130:	75 2c                	jne    115e <printf+0x6a>
      if(c == '%'){
    1132:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1136:	75 0c                	jne    1144 <printf+0x50>
        state = '%';
    1138:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    113f:	e9 4a 01 00 00       	jmp    128e <printf+0x19a>
      } else {
        putc(fd, c);
    1144:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1147:	0f be c0             	movsbl %al,%eax
    114a:	89 44 24 04          	mov    %eax,0x4(%esp)
    114e:	8b 45 08             	mov    0x8(%ebp),%eax
    1151:	89 04 24             	mov    %eax,(%esp)
    1154:	e8 bb fe ff ff       	call   1014 <putc>
    1159:	e9 30 01 00 00       	jmp    128e <printf+0x19a>
      }
    } else if(state == '%'){
    115e:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    1162:	0f 85 26 01 00 00    	jne    128e <printf+0x19a>
      if(c == 'd'){
    1168:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    116c:	75 2d                	jne    119b <printf+0xa7>
        printint(fd, *ap, 10, 1);
    116e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1171:	8b 00                	mov    (%eax),%eax
    1173:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    117a:	00 
    117b:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1182:	00 
    1183:	89 44 24 04          	mov    %eax,0x4(%esp)
    1187:	8b 45 08             	mov    0x8(%ebp),%eax
    118a:	89 04 24             	mov    %eax,(%esp)
    118d:	e8 aa fe ff ff       	call   103c <printint>
        ap++;
    1192:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1196:	e9 ec 00 00 00       	jmp    1287 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    119b:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    119f:	74 06                	je     11a7 <printf+0xb3>
    11a1:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    11a5:	75 2d                	jne    11d4 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    11a7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11aa:	8b 00                	mov    (%eax),%eax
    11ac:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    11b3:	00 
    11b4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    11bb:	00 
    11bc:	89 44 24 04          	mov    %eax,0x4(%esp)
    11c0:	8b 45 08             	mov    0x8(%ebp),%eax
    11c3:	89 04 24             	mov    %eax,(%esp)
    11c6:	e8 71 fe ff ff       	call   103c <printint>
        ap++;
    11cb:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11cf:	e9 b3 00 00 00       	jmp    1287 <printf+0x193>
      } else if(c == 's'){
    11d4:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    11d8:	75 45                	jne    121f <printf+0x12b>
        s = (char*)*ap;
    11da:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11dd:	8b 00                	mov    (%eax),%eax
    11df:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    11e2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    11e6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    11ea:	75 09                	jne    11f5 <printf+0x101>
          s = "(null)";
    11ec:	c7 45 f4 5c 16 00 00 	movl   $0x165c,-0xc(%ebp)
        while(*s != 0){
    11f3:	eb 1e                	jmp    1213 <printf+0x11f>
    11f5:	eb 1c                	jmp    1213 <printf+0x11f>
          putc(fd, *s);
    ...
    120a:	e8 05 fe ff ff       	call   1014 <putc>
          s++;
    120f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    121b:	75 da                	jne    11f7 <printf+0x103>
    121d:	eb 68                	jmp    1287 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    121f:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1223:	75 1d                	jne    1242 <printf+0x14e>
        putc(fd, *ap);
    1225:	8b 45 e8             	mov    -0x18(%ebp),%eax
    ...
    1237:	e8 d8 fd ff ff       	call   1014 <putc>
        ap++;
    123c:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1240:	eb 45                	jmp    1287 <printf+0x193>
      } else if(c == '%'){
    1242:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1246:	75 17                	jne    125f <printf+0x16b>
        putc(fd, c);
    ...
    1258:	e8 b7 fd ff ff       	call   1014 <putc>
    125d:	eb 28                	jmp    1287 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    125f:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    1266:	00 
    1267:	8b 45 08             	mov    0x8(%ebp),%eax
    126a:	89 04 24             	mov    %eax,(%esp)
    126d:	e8 a2 fd ff ff       	call   1014 <putc>
        putc(fd, c);
    1272:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1275:	0f be c0             	movsbl %al,%eax
    1278:	89 44 24 04          	mov    %eax,0x4(%esp)
    127c:	8b 45 08             	mov    0x8(%ebp),%eax
    127f:	89 04 24             	mov    %eax,(%esp)
    1282:	e8 8d fd ff ff       	call   1014 <putc>
      }
      state = 0;
    1287:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    128e:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    ...
    129f:	0f 85 71 fe ff ff    	jne    1116 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    12ab:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    12ae:	8b 45 08             	mov    0x8(%ebp),%eax
    12b1:	83 e8 08             	sub    $0x8,%eax
    12b4:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12b7:	a1 4c 1c 00 00       	mov    0x1c4c,%eax
    12bc:	89 45 fc             	mov    %eax,-0x4(%ebp)
    12bf:	eb 24                	jmp    12e5 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    12c1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12c4:	8b 00                	mov    (%eax),%eax
    12c6:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    12c9:	77 12                	ja     12dd <free+0x35>
    12cb:	8b 45 f8             	mov    -0x8(%ebp),%eax
    12ce:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    12d1:	77 24                	ja     12f7 <free+0x4f>
    12d3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12d6:	8b 00                	mov    (%eax),%eax
    12d8:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    12db:	77 1a                	ja     12f7 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    12e2:	89 45 fc             	mov    %eax,-0x4(%ebp)
    12e5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    12e8:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    12eb:	76 d4                	jbe    12c1 <free+0x19>
    12ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
    12f0:	8b 00                	mov    (%eax),%eax
    12f2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    12f5:	76 ca                	jbe    12c1 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    12f7:	8b 45 f8             	mov    -0x8(%ebp),%eax
    12fa:	8b 40 04             	mov    0x4(%eax),%eax
    12fd:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    1304:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1307:	01 c2                	add    %eax,%edx
    1309:	8b 45 fc             	mov    -0x4(%ebp),%eax
    130c:	8b 00                	mov    (%eax),%eax
    130e:	39 c2                	cmp    %eax,%edx
    1310:	75 24                	jne    1336 <free+0x8e>
  ...
  if(p + p->s.size == bp){
    ...
    1352:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1355:	75 20                	jne    1377 <free+0xcf>
    p->s.size += bp->s.size;
    1357:	8b 45 fc             	mov    -0x4(%ebp),%eax
    135a:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    136e:	8b 10                	mov    (%eax),%edx
    1370:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1373:	89 10                	mov    %edx,(%eax)
    1375:	eb 08                	jmp    137f <free+0xd7>
  } else
    p->s.ptr = bp;
  ...
  freep = p;
    ...
    1382:	a3 4c 1c 00 00       	mov    %eax,0x1c4c
}
    1387:	c9                   	leave  
    1388:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    138f:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    1396:	77 07                	ja     139f <morecore+0x16>
    nu = 4096;
    1398:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    139f:	8b 45 08             	mov    0x8(%ebp),%eax
    13a2:	c1 e0 03             	shl    $0x3,%eax
    13a5:	89 04 24             	mov    %eax,(%esp)
    13a8:	e8 3f fc ff ff       	call   fec <sbrk>
    13ad:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    13b0:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13b4:	75 07                	jne    13bd <morecore+0x34>
    return 0;
    13b6:	b8 00 00 00 00       	mov    $0x0,%eax
    13bb:	eb 22                	jmp    13df <morecore+0x56>
  hp = (Header*)p;
    13bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13c0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    13c3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13c6:	8b 55 08             	mov    0x8(%ebp),%edx
    13c9:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    13cc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13cf:	83 c0 08             	add    $0x8,%eax
    13d2:	89 04 24             	mov    %eax,(%esp)
    13d5:	e8 ce fe ff ff       	call   12a8 <free>
  return freep;
    13da:	a1 4c 1c 00 00       	mov    0x1c4c,%eax
}
    13df:	c9                   	leave  
    13e0:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    13e4:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    13e7:	8b 45 08             	mov    0x8(%ebp),%eax
    13ea:	83 c0 07             	add    $0x7,%eax
    13ed:	c1 e8 03             	shr    $0x3,%eax
    13f0:	83 c0 01             	add    $0x1,%eax
    13f3:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    13f6:	a1 4c 1c 00 00       	mov    0x1c4c,%eax
    13fb:	89 45 f0             	mov    %eax,-0x10(%ebp)
    13fe:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1402:	75 23                	jne    1427 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1404:	c7 45 f0 44 1c 00 00 	movl   $0x1c44,-0x10(%ebp)
    140b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    140e:	a3 4c 1c 00 00       	mov    %eax,0x1c4c
    1413:	a1 4c 1c 00 00       	mov    0x1c4c,%eax
    1418:	a3 44 1c 00 00       	mov    %eax,0x1c44
    base.s.size = 0;
    141d:	c7 05 48 1c 00 00 00 	movl   $0x0,0x1c48
    1424:	00 00 00 
  }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14af:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    14ba:	e9 70 ff ff ff       	jmp    142f <malloc+0x4e>
}
    14bf:	c9                   	leave  
    14c0:	c3                   	ret    
...
void mutex_lock(mutex_t *m)
{
  ...
  while (xchg(&m->flag, 1) == 1); // spin-wait (do nothing)
    ...
    14f6:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    14fd:	00 
    14fe:	89 04 24             	mov    %eax,(%esp)
    1501:	e8 be ff ff ff       	call   14c4 <xchg>
    1506:	83 f8 01             	cmp    $0x1,%eax
    1509:	74 e8                	je     14f3 <mutex_lock+0x7>
}
    150b:	c9                   	leave  
    150c:	c3                   	ret    

0000150d <mutex_unlock>:
...
void mutex_unlock(mutex_t *m)
{
  ...
  m->flag = 0;
    ...
    1513:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
} 
    1519:	5d                   	pop    %ebp
    151a:	c3                   	ret    

0000151b <thread_create>:
...
00001551 <thread_join>:

int thread_join(void)
{
    1551:	55                   	push   %ebp
    1552:	89 e5                	mov    %esp,%ebp
    1554:	83 ec 28             	sub    $0x28,%esp
    void *join_s;
    int join_pid = join(&join_s);
    1557:	8d 45 f0             	lea    -0x10(%ebp),%eax
    155a:	89 04 24             	mov    %eax,(%esp)
    155d:	e8 aa fa ff ff       	call   100c <join>
